FUNCTION zfnhr_int_rep_remove.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
*"     REFERENCE(I_REMOVE_REP) TYPE  ZSHR_REMOVE_REP OPTIONAL
*"  EXPORTING
...
* data declarations
  ...
  DATA: lo_http_client     TYPE REF TO if_http_client,
        ...
        lv_url             TYPE string  VALUE '/erp/empregado/delete',
        http_status        TYPE string,
        lv_body            TYPE string,
        json_req           TYPE zshr_remove_rep.
...
* ABAP to JSON
    MOVE-CORRESPONDING i_remove_rep TO json_req.
    ...
    TRY.
      ...
      CATCH  cx_rest_client_exception INTO oref.
        ...
        IF e_reason IS NOT INITIAL.
          ...
          wa_zhrlog_int_rep-matricula = i_remove_rep-matricula.
          wa_zhrlog_int_rep-acao = 'R'.
...
* Collect response
    ...
    IF e_reason IS NOT INITIAL.
      ...
      IF e_reason EQ 'OK'.
        wa_zhrlog_int_rep-resposta = text-002.
      ELSE.
